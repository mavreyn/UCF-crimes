...
def address_to_place(address: str, typo_tolerance=1, try_selenium=True, driver_path=None) -> str | None:
    '''
    ...
    if try_selenium and driver_path:
        if (selenium_result := selenium_scrape(address, driver_path)):
